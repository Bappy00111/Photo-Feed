...
const PageDeatails = async ({ id, lang }) => {
    // console.log(`Photo ID: ${id}, Language: ${lang}`);
    const response = await fetch(`${process.env.BASE_API_URL}/photos/${id}?lang=${lang}`);
